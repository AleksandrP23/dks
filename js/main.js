...
/* harmony import */ var _components_elipsis__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/elipsis */ "./src/js/components/elipsis.js");
...
/* harmony import */ var _components_input_file__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/input-file */ "./src/js/components/input-file.js");
/* harmony import */ var _components_input_file__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_input_file__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _components_filter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/filter */ "./src/js/components/filter.js");
/* harmony import */ var _components_filter__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_components_filter__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var _components_mask__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_components_mask__WEBPACK_IMPORTED_MODULE_10__);
...
if (document.querySelector('.accordion')) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const checkWindowSize = () => {
      const buttons = document.getElementsByClassName("accordion__control");
...
ellipsis_js__WEBPACK_IMPORTED_MODULE_0___default()({
  ellipsis: '…',
  debounce: 300,
  lines: 4,
  break_word: false
...
if (document.querySelector('.accordion')) {
  document.addEventListener('DOMContentLoaded', function () {
    var btn = document.getElementById('btn-aside'),
      block = document.getElementById('catalog-filter__form');
...
if (document.querySelector('.form')) {
  const fileInput = document.querySelector('.form__label-file input');
  ...
  fileInput.addEventListener('change', e => {
    ...
    if (filesLength) {
      e.currentTarget.closest('.form__label-file').querySelector('span').textContent = `${filesLength} ${declOfNum(filesLength, ['файл', 'файла', 'файлов'])}`;
    }
  });
}
...
if (document.querySelector('.map')) {
  let center = [55.73641522821378, 37.61366566137695];
  function init() {
    let map = new ymaps.Map('map', {
      center: center,
      zoom: 16
    });
    let placemark = new ymaps.Placemark([55.73451446192575, 37.613451084655765], {}, {
...
searchInput.addEventListener('input', () => {
  ...
  if (query.length > 0) {
    // Здесь нужно отправить запрос на сервер и получить результаты
    // В этом примере просто генерируем фейковые результаты
    const results = ['Результат 1', 'Результат 2', 'Результат 3', 'Результат 4', 'Результат 5'];
    ...
    // Если запрос пустой, скрываем список результатов
    resultsList.style.display = 'none';
  }
});

// Скрываем список результатов при клике вне поля ввода или списка
...
if (document.querySelector('.page-catalog')) {
  const showMore = document.querySelector('.page-catalog__show-more');
  const productsLength = document.querySelectorAll('.page-catalog__item--more').length;
  let items = 9;
  if (productsLength < 9) {
  ...
  showMore.addEventListener('click', () => {
    items += 3;
    const array = Array.from(document.querySelector('.page-catalog__list').children);
...
if (document.querySelector('.news-cards')) {
  const showMoreNew = document.querySelector('.news-cards__show-more');
  const productsLengthNew = document.querySelectorAll('.news-cards__item--more').length;
  let itemsNew = 7;
  if (productsLengthNew < 7) {
    showMoreNew.style.display = 'none';
  } else {
    showMoreNew.style.display = '';
  }
  showMoreNew.addEventListener('click', () => {
    itemsNew += 3;
    const array = Array.from(document.querySelector('.news-cards__list').children);
    const visItems = array.slice(0, itemsNew);
    visItems.forEach(el => el.classList.add('is-visible'));
    if (visItems.length === productsLengthNew) {
      showMoreNew.style.display = 'none';
    }
  });
}
...
const swipersHeros = document.querySelector('.hero-slider');
const swipersPhotos = document.querySelector('.news-photo__slider');
const swipersCerts = document.querySelector('.card-cert__slider');
const swipersSizes = document.querySelector('.card-size__slider');
const swipersRelateds = document.querySelector('.card-related__slider');
if (swipersHeros) {
...
;
if (swipersCerts) {
  const swipersCert = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersCerts, {
    slidesPerView: 1,
    spaceBetween: 10,
    // centeredSlides: true,
    loop: true,
...
;
if (swipersSizes) {
  const swipersSize = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersSizes, {
    slidesPerView: 1,
    spaceBetween: 10,
    // centeredSlides: true,
    loop: true,
...
;
if (swipersRelateds) {
  const swipersRelated = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersRelateds, {
    slidesPerView: 1,
    spaceBetween: 10,
    // centeredSlides: true,
    loop: true,
